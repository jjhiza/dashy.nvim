...
local function check_nvim_version()
    ...
    if
        version.major < required[1]
        or (version.major == required[1] and version.minor < required[2])
        or (version.major == required[1] and version.minor == required[2] and version.patch < required[3])
    then
        return false
    end
